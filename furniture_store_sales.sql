	/*SELECT * FROM SALES WHERE price > 2000;*/
	/*
	SELECT * FROM SALES WHERE price > 2000 AND product = "Bed";
	
	/*SELECT product FROM sales  WHERE price > 3000  ;*/



	/*SELECT AVG(price) FROM sales ;*/
SELECT * FROM SALES;
SELECT country, account_created as acc   FROM SALES GROUP BY account_created;
	/*SELECT * FROM SALES;*/

	/*SELECT * FROM SALES WHERE transaction_date > 1/01/09*/;

	/*SELECT * FROM SALES WHERE transaction_date > 1/01/2022*/
	/*
